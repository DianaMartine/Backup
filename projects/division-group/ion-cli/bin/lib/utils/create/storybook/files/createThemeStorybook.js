...
const createThemeStorybook = (verbose) => __awaiter(void 0, void 0, void 0, function* () {
    verbose &&
        (0, log_1.default)({
            context: "info",
    ...
    yield (0, prompts_1.default)([
        ...
        switch (res.options) {
            case "default":
                return fs_1.default.writeFileSync("./.storybook/theme.ts", `import { create } from "@storybook/theming/create";
...
brandTarget: "${res.brandTarget}",
                    ...
                    if (res.fontBase) {
                        yield (0, prompts_1.default)([
                            ...
                            theme = theme.replace("});", `fontBase: '${res.fontBase}',
fontCode: "${res.fontCode}",
                    ...
                    if (res.style) {
                        yield (0, prompts_1.default)([
                            ...
                            theme = theme.replace("});", `colorPrimary: "${res.colorPrimary}",
...
booleanSelectedBg: "${res.booleanSelectedBg}",
                    ...
                    fs_1.default.writeFileSync("./.storybook/theme.ts", theme);
                    verbose &&
                        (0, log_1.default)({
                            context: "success",
...
exports.default = createThemeStorybook;
